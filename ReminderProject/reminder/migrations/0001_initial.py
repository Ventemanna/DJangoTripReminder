    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transport', models.CharField(choices=[('driving', 'автомобиль'), ('truck', 'грузовой автомобиль'), ('walking', 'пешеход'), ('transit', 'общественный транспорт'), ('bicycle', 'велосипед'), ('scooter', 'электросамокат')], max_length=10)),
                ('reminder_time', models.DateTimeField(blank=True, null=True)),
                ('notification_method', models.CharField(choices=[('email', 'По email'), ('telegram', 'В telegram чат'), ('both', 'Email и telegram')], default='email', max_length=10)),
